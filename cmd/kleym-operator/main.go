...
func init() {
	...
	utilruntime.Must(kleymv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	// If metrics certificates are not mounted, controller-runtime generates
	// self-signed certificates for the metrics server. Deployments that provide
	// a trusted metrics-server-cert Secret can mount it with
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a558cee8.sonda.red",
