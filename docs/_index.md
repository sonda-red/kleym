...
title: Documentation
toc: false
summary: Entry point for the kleym documentation.
description: Use the documentation sidebar to browse concepts, reference material, examples, troubleshooting, and contributor workflow.
cascade:
  type: docs
---
...
For the authoritative behavior and API contract, use the [spec](/spec).
