...
// InferenceTrustBindingSpec defines the desired state of InferenceTrustBinding
type InferenceTrustBindingSpec struct {
	...
	// foo is an example field of InferenceTrustBinding. Edit inferencetrustbinding_types.go to remove/update
	// +optional
